...
use y1 x42000 x42001 x5729 x7362 x5751 x7650 ///
    ...
    x3902 x4006 x6820 x6835 x4018 x4022 x4020 x4026 x4024 x4030 x4028 ///
...
gen YEAR = 2001                /* Indicates data is from which wave */
...
scalar CPIADJ = CPIBASE/2618            /* Adjust with CPI (adjusted to 1992$ price) */
scalar CPILAG = 2600/2529               /* Income is the previous year's income level, CPILAG adjust income to survey year */
