* This file selects variables, using SCF2007
...
gen YEAR = 2007                /* Indicates data is from which wave */
...
scalar CPIADJ = CPIBASE/3062            /* Adjust with CPI (adjusted to 1992$ price) */
scalar CPILAG = 3045/2961               /* Income is the previous year's income level, CPILAG adjust income to survey year */
